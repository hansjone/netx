...
class UmeInventoryNE(Base):
    ...
    device_level: Mapped[str] = mapped_column(String(64), default="")
    host_name: Mapped[str] = mapped_column(String(256), default="")
    location: Mapped[str] = mapped_column(String(512), default="")
    hardware_version: Mapped[str] = mapped_column(String(128), default="")
    loopback: Mapped[str] = mapped_column(String(128), default="")
    consistent_state: Mapped[str] = mapped_column(String(64), default="")
    interface_version: Mapped[str] = mapped_column(String(128), default="")
    mac: Mapped[str] = mapped_column(String(128), default="")
    admin_status: Mapped[str] = mapped_column(String(64), default="")
    address_type: Mapped[str] = mapped_column(String(64), default="")
    connection_status: Mapped[str] = mapped_column(String(64), default="")
    maintain_status: Mapped[str] = mapped_column(String(64), default="")
    net_mask: Mapped[str] = mapped_column(String(128), default="")
