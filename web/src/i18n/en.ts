const en = {
  ...
  workbench: {
    ...
    fleetNePass: "Pass",
    fleetNeFail: "Fail",
    fleetNeTesting: "Testing",
    fleetNeUnknown: "Untested",
    fleetNeNoTag: "No tag",
    fleetNeTags: "Top tags",
    fleetTopo: "Topology",
    fleetTopoNodes: "nodes",
    fleetTopoEdges: "edges",
    fleetTopoOther: "Other regions",
    fleetTopoUnassigned: "Unassigned",
    fleetTopoNoRegion: "No regions",
    fleetTopoDiscover: "Last discover",
    fleetTopoUpdated: "Summary updated",
    fleetSched: "Schedulers",
    fleetSchedConfig: "Config sync",
    fleetSchedLldp: "LLDP",
    fleetSchedPort: "Port traffic",
    fleetSchedNeCollect: "NE collect",
    fleetSchedFabric: "Fabric reconcile",
    fleetSchedOn: "ON",
    fleetSchedOff: "OFF",
    fleetSchedMode: "Mode",
    fleetSchedHeartbeat: "Heartbeat",
    fleetSchedFresh: "Fresh",
    fleetSchedStale: "Stale",

    sidePanel: "Console side panel",
    consoleId: "OPS CONSOLE",
    refreshedAt: "Updated {{time}}",
    taskRail: "ACTIVE TASKS",
    taskRailAll: "ALL",
    taskRailEmpty: "No active tasks",
    taskTotal: "POOL {{count}}",
  ...
  bizState: {
    ...
    createModeImport: "Import log",
    createImportHint:
      "No NE needed: upload a session log or zip to create an Import task and parse the first batch. Re-import later on the task to append batches (same as multiple collects).",
    createImportSubmit: "Create & import",
    created: "Task created",
    createFailed: "Create failed",
    empty: "No business-state tasks yet.",
    pickNe: "Select NE…",
    neKeywordPh: "Name / IP / ID",
    allSource: "All sources",
    selectedNe: "Selected",
    neEmpty: "No matching NEs.",
    colSource: "Source",
    colVendor: "Vendor",
    colConnect: "Connect",
    start: "Start schedule",
    pause: "Pause",
    statusPaused: "Manual only",
    ...
    importLogHint:
      "Append a new batch to this task (same as one collect): full session or zip; discard noise before show/display; split on hostname#show; fail if no show (no SSH).",
    importVendor: "Vendor",
    importVendorGeneric: "Generic (show+display)",
    importFile: "Log file",
    importNeName: "Task name (optional)",
    importNeNamePh: "e.g. PE1-offline",
    importSubmit: "Import as new batch",
    importing: "Importing",
    importStarted: "Import started ({{count}} segments)",
    importOfflineOnly: "Import tasks are offline-only (no SSH collect)",
    sourceImport: "Import",
    ...
    colAlias: "Alias",
    setAlias: "Set alias",
    aliasPrompt: "Batch alias (preferred in compare/cutover pickers; empty clears)",
    aliasSaved: "Alias saved",
    aliasEmpty: "Untitled",
    workbookStats: "Compare {{compare}} · With data {{withData}} · Sheets {{sheets}}",
    deleteBatch: "Delete",
    ...
    cancel: "Close",
    bindTitle: "Select bindings",
    unbound: "Not bound",
    bindHintRequired: "Bind params before collect",
    paramsDblClickHint: "Click to view all bindings",
    paramsClickHint: "Click to view all bindings",
    paramsDetailTitle: "Bound parameters",
    paramsDetailCount: "{{n}} binding(s)",
    discoverLoading: "Discovering…",
    discoverEmpty: "No candidates discovered",
    discoverCacheHit: "reused (no re-login)",
    discoverRefresh: "Refresh from device",
    selectAllVrfs: "Select all",
    deselectAllVrfs: "Deselect all",
    batches: "Batches",
    viewBatch: "Open",
    batchDetail: "Detail",
    export: "Export",
    ...
    exportRawLog: "Export as text",
    exportRawLogOk: "Log exported",
    noBatches: "No batches yet",
    batchCollectDetail: "Collect detail",
    batchWorkbook: "Batch workbook",
    batchId: "Batch ID",
    copyBatchId: "Copy batch ID",
    batchMessageEmpty: "No message or error",
    batchCmdSummary:
      "{{ok}} ok / {{fail}} failed / {{skipped}} skipped / {{other}} other · {{total}} counted (batch {{batchCmds}} cmds)",
    ...
    sheetConfigIface: "Interface intent",
    sheetConfigVrf: "VRF intent",
    sheetConfigBgp: "BGP intent",
    sheetFilterPh: "Filter this sheet…",
    sheetEmpty: "No rows in this sheet",
    sheetLoading: "Loading…",
    collectCommand: "Collect command",
    viewRawLog: "Raw log",
    rawLogTitle: "Raw collect log",
    rawLogEmpty: "No raw output",
    rawLogStats: "{{lines}} lines collected · {{rows}} rows stored",
    rawLogDeclared: "declared {{declared}}",
    ...
    colTime: "Time",
    colRows: "DB rows",
    colRawLines: "CLI lines",
    colDeclared: "Declared",
    colActions: "Actions",
    colCommand: "Command",
    colMessage: "Message",
    pickTask: "Open details to manage a task",
  ...
  bizCompare: {
    ...
    compareFields: "Compare",
    compareMode: "Mode",
    tolerance: "Tolerance",
    displayField: "Display",
    keyAlwaysDisplay: "Key columns are always shown",
    modeEq: "Exact equal",
    ...
    field: "Field",
    note: "Note",
    keyRequired: "Select at least one key field",
    keyIsIdentity: "Key aligns rows; not used as a value-compare field",
    metricsRequired: "Add at least one metric sheet",
    noMetricFields: "No fields for this metric",
    ...
    normalizeMac: "MAC",
    normalizeEmpty: "empty→blank",
    templateFilterPh: "Filter template / metric",
    jobFilterPh: "Filter job / template / status",
    ...
    validateNeed: "Select mapping and before/after batches first",
    mapHint:
    ...
    jobDeleted: "Compare job deleted",
    ...
    kindDiff: "Fail",
    kindAdded: "Added",
    kindRemoved: "Missing only",
    kindChanged: "Mismatch only",
    kindUnchanged: "Pass",
    kindAddedShort: "Added",
    kindRemovedShort: "Missing",
    kindChangedShort: "Mismatch",
    kindUnchangedShort: "Pass",
    kindFail: "Fail",
    kindPass: "Pass",
    kindSuccess: "Pass",
    successCount: "Pass",
    ...
    resultFilterPh: "Filter identity / values…",
    diffCount: "{{n}} failed",
    passRate: "Pass rate",
    passOk: "All passed",
    passWarn: "Has failures",
    runOverview: "Verdict",
    sheetCurrent: "Current check",
    diffCountLabel: "Failed rows",
    diffRate: "Fail rate",
  ...
  bizMigration: {
    ...
    emptyProjects: "No cutover tasks yet",
    listFilterPh: "Filter name / NE / IP / status",
    kpiProjects: "Tasks",
    kpiActive: "Active",
    detail: "Detail",
    cancel: "Close",
